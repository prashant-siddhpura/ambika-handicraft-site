        ...
        <div className="sanctuary-grid">
          ...
          <div className="map-card reveal" ref={infoRef}>
            <div className="map-embed-wrap">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1744.4301419444048!2d72.55651953857205!3d23.079804394783466!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e837246fdeb2b%3A0x95c42e91a5bbfb52!2sShree%20Ambika%20Handicraft!5e1!3m2!1sen!2sin!4v1782888212334!5m2!1sen!2sin"
            ...
            <div className="map-meta">
              ...
              <div className="info-item info-item--socials">
                {/* <div className="info-icon" aria-hidden="true">✨</div> */}
                <div>
                  <p className="label">Connect With Us</p>
                  <div className="sanc-social-row">
                    <a
                      href="https://www.instagram.com/bhaskarsiddhpura/"
                      className="sanc-social-icon sanc-social-icon--insta"
                      target="_blank"
                    ...
                    <a
                      ...
                      className="sanc-social-icon sanc-social-icon--fb"
                      target="_blank"
                      rel="noopener noreferrer"
                    ...
                    <a
                      ...
                      className="sanc-social-icon sanc-social-icon--yt"
                      target="_blank"
                      rel="noopener noreferrer"
                    ...
                    <a
                      ...
                      className="sanc-social-icon sanc-social-icon--wa"
                      target="_blank"
                      rel="noopener noreferrer"
